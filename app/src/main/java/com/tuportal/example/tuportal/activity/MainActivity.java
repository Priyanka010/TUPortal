    ...
    protected void onCreate(Bundle savedInstanceState) {
                                            ...
                                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                if (i == 0) {
                                                   ...
                                                   // aboutcsit.putExtra("listname",listView.getItemAtPosition(i).toString());
                                                    ...
                                                    Intent syllabus= new Intent(MainActivity.this, SyllabusActivity.class);
                                                    startActivity(syllabus);
                                                }
                                                else if (i == 4) {
                                                    Intent college= new Intent(MainActivity.this, CollegeListActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.ExamCenter:
                        intent=new Intent((MainActivity.this),MapsActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.Internalqus:
                        intent=new Intent((MainActivity.this),InternalQusActivity.class);
                        startActivity(intent);
                        return true;
                }
        ...
        toggle = new ActionBarDrawerToggle(this, drawerLayout,toolbar,R.string.drawer_open, R.string.drawer_close) {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                getSupportActionBar().setTitle("CSIT Portal");
            }
